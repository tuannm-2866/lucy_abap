...
define view entity ZI_SCHEDULE_OSAP9 as select from zschedule_osap9 as Schedule
  association to parent ZI_COURSE_OSAP9 as _Course on $projection.CourseUuid = _Course.CourseUuid
{
